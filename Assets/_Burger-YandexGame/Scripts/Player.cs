...
//    private float _colliderSize = 0f;
...
//        _colliderSize = Mathf.Lerp(_colliderSize, targetAngle, Time.deltaTime * _rockingSmooth);
//        _burgerComponents.localRotation = Quaternion.Euler(0, 0, _colliderSize);
//    }
...
//                float ingredientHeight = _ingredients[i].BoxCollider != null ? _ingredients[i].BoxCollider.size.y : 0;
//                BurgerTop.transform.localPosition = new Vector3(0, newPos.y + ingredientHeight, 0);
